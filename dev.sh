...
# CONFIG SOURCE
# =============================
RAW_BASE="https://raw.githubusercontent.com/USERNAME/dev-installer/main"
  ...
  for cfg in $CONFIGS; do
    case "$cfg" in
      zsh)
        ...
        curl -fsSL "$RAW_BASE/zsh/.zshrc" -o "$USER_HOME/.zshrc"
      ...
      tmux)
        ...
        mkdir -p "$TMUX_DIR"
        curl -fsSL "$RAW_BASE/tmux/tmux.conf" -o "$TMUX_DIR/tmux.conf"
